...
public final class NISTClient {
	...
	static TimePoint asTimePoint(String nistRawFormattedString) {
	...
	static TimePoint now(String serverName, int port) throws IOException {
		byte buffer[] = new byte[256]; // CHECKSTYLE IGNORE THIS LINE
	...
	static TimeSource timeSource(final String serverName, final int port) {
