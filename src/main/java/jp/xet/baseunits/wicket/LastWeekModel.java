...
/**
 * {@link TimeZone}のモデルより、「先週」を表現するモデル。
 */
@SuppressWarnings("serial")
public class LastWeekModel extends LoadableDetachableModel<CalendarWeek> {
	 ...
	 */
	public LastWeekModel(IModel<TimeZone> timeZoneModel) {
	 ...
	 * @throws IllegalArgumentException 引数に{@code null}を与えた場合
	 */
	public LastWeekModel(TimeZone timeZone) {
	...
	protected CalendarWeek load() {
		return Clock.today(timeZoneModel.getObject()).asCalendarWeek().previousWeek();
	}
}
